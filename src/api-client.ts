...
export class ApiClient {
	...
	static CurseForge = new ApiClient("https://api.curseforge.com/v1/mods/", { "x-api-key": process.env.CF_API_KEY }, true)
	...
	constructor(url: string, headers?: object, trailingSlash = false) {
		this.url = url
